<template>
  <q-page padding class="">
      ...
      <div v-else>
        <div id="printMe">
          <div class="page-header" style="text-align: center; font-family: Arial; font-size: 10px;">
            <table id="report" style="text-align: left; width: 100%; margin-top: 60px;">
              <tr>
            ...
            <tbody>
              <table id="report" style="text-align: left; width: 100%; font-family: Arial; font-size: 10px;">
                ...
                <tr>
                  ...
                  <td> Year Graduated: <b> {{ transcript_data.year_graduated }} </b> </td>
                </tr>
                <tr>
                ...
                <td>
                  ...
                  <div class="page" style="font-family: Arial; font-size: 10px;">
                    <table style="text-align: left; width:100%; border-collapse: collapse;">
                      ...
                      <tr>
                        <td align="center"></td>
                        <th align="left" colspan="2"> A.Y. 2015-2016, First Trimester </th>
                        <td align="center"></td>
                        <td align="center"></td>
                        <td align="center"></td>
                      </tr>
                      ...
                      <tr v-for="(x) in first_year_first_trimester" :key="x.id">
                        <td align="center"> {{ x.subject_code }} </td>
                        <td align="left">  {{ x.subject_name }} </td>
                        <td align="center"> {{ x.percentage_grade }} </td>
                        <td align="center"> {{ x.numerical_grade}} </td>
                        <td align="center"></td>
                      ...
                      <tr>
                        <td align="center"></td>
                        <th align="left" colspan="2"> A.Y. 2015-2016, Second Trimester </th>
                        <td align="center"></td>
                        <td align="center"></td>
                        <td align="center"></td>
                      </tr>
                      ...
                      <tr>
                        <td align="center"></td>
                        <th align="left" colspan="2"> A.Y. 2015-2016, Third Trimester </th>
                        <td align="center"></td>
                        <td align="center"></td>
                        <td align="center"></td>
                      </tr>
                      ...
                      <tr>
                        <td align="center"></td>
                        <th align="left" colspan="2"> Second Year </th>
                        <td align="center"></td>
                        <td align="center"></td>
                        <td align="center"></td>
                      </tr>
                      <tr>
                        <td align="center"></td>
                        <th align="left" colspan="2"> A.Y. 2016-2017, First Trimester </th>
                        <td align="center"></td>
                        <td align="center"></td>
                        <td align="center"></td>
                      </tr>
                      ...
                      <tr v-for="(x) in second_year_first_trimester" :key="x.id">
                        <td align="center"> {{ x.subject_code }} </td>
                        <td align="left">  {{ x.subject_name }} </td>
                        <td align="center"> {{ x.percentage_grade }} </td>
                        <td align="center"> {{ x.numerical_grade}} </td>
                      ...
                      <tr>
                        <td align="center"></td>
                        <th align="left" colspan="2"> A.Y. 2016-2017, Second Trimester </th>
                        <td align="center"></td>
                        <td align="center"></td>
                        <td align="center"></td>
                      </tr>
                      ...
                      <tr>
                        <td align="center"></td>
                        <th align="left" colspan="2"> Third Year </th>
                        <td align="center"></td>
                        <td align="center"></td>
                        <td align="center"></td>
                      </tr>
    ...
    <q-btn color="negative" v-print="'#printMe'" v-if="!print_prep"> Print </q-btn>
  </q-page>
</template>
