    ...
    <div class="my-card">
      ...
      >
        ...
        <template v-slot:top-right>
          <q-btn color="primary" icon-right="person" label="Register" :disable="create_button_disable" to="/SMRegister" />
        </template>
        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <q-td align="left">
              {{ props.row.scholarship_percentage }}
            </q-td>
            <q-td align="left">
...
export default {
  data () {
    ...
    return {
      ...
      columns: [
        ...
        { name: 'sponsor_name', label: 'Sponsor', field: 'sponsor_name', align: 'left', sortable: true },
        { name: 'scholarship_percentage', label: 'Scholarship', field: 'scholarship_percentage', align: 'left', sortable: true },
  ...
  async created () {
    ...
    if (self.$store.state.user_info.user_group === 'Student Assistant') {
      self.delete_button_disable = true
    } else {
      self.delete_button_disable = false
    }
  ...
  methods: {
    getPayload (data) {
      var self = this
      self.$store.commit('StudentManagement/setPut', data)
      self.$router.push('/SMUpdate')
    },
