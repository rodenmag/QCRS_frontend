  ...
  <q-layout view="hHh lpR fFf" class="bg-grey-1">
    <q-header elevated class="bg-white text-grey-8 q-py-xs" height-hint="58">
      <q-toolbar>
        ...
        <q-btn flat no-caps no-wrap class="q-ml-xs" v-if="$q.screen.gt.xs">
          <q-icon name="summarize" color="red" size="28px" />
        ...
        <div class="q-gutter-sm row items-center no-wrap">
          <q-btn round dense flat color="grey-8" icon="account_circle" to="/Home" v-if="$q.screen.gt.sm">
          ...
          <q-btn round dense flat color="blue-7" icon="summarize" to="/ReportManagement" v-if="$q.screen.gt.sm">
    ...
    >
      <q-scroll-area class="fit">
        <q-list padding>
          <q-item to="/transcript" v-ripple clickable>
          ...
          <q-item to="/billing" v-ripple clickable>
            <q-item-section avatar>
              <q-icon name="work" />
            </q-item-section>
            <q-item-section>
          ...
          <q-item to="/browse_grades" v-ripple clickable>
            <q-item-section avatar>
              <q-icon name="payment" />
            </q-item-section>
            <q-item-section>
